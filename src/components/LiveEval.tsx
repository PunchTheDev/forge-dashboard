      ...
      {(result.fea_element_count != null || result.fea_displacement_mm != null) && (
        <div className="grid grid-cols-2 gap-3 mb-4">
          ...
          {result.similarity != null && (
            <div>
              <div className="text-xs text-forge-muted" title="How similar this design is to the current #1 submission (geometric similarity check — too similar = rejected to prevent copy-wins)">Similarity to #1</div>
